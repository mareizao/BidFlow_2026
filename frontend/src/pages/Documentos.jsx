...
import { downloadDocumento } from "../api/docApi";
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead className="bg-slate-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                  <tr>
                    <th className="py-4 px-6 text-xs font-semibold tracking-widest text-primary dark:text-blue-400 uppercase">
                      Documento
                    </th>
                    <th className="py-4 px-6 text-xs font-semibold tracking-widest text-primary dark:text-blue-400 uppercase">
                      Licitación Asociada
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  {documentos.map((doc) => (
                    ...
                    >
                      ...
                      {/* ✅ COLUMNA NUEVA: Acción de descarga */}
                      <td className="py-4 px-6">
                        <button
                          onClick={() =>
                            downloadDocumento(doc.id, doc.filename)
                          }
